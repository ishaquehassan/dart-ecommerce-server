...
class CategoriesController extends ApiController{
  ...
  Future<BaseResponseModel> create() async{
    ...
    try{
      ...
      if(existingEmailCheck != null){
        throw ResponseModel("Category already exists with same title",statusCode: 409);
      }
    }
    ...
    try{
      ...
      throw ResponseModel("Unable to save Category. Reason: ${e.toString()}",statusCode: 500);
    }
  }
  ...
  Future<BaseResponseModel> delete(int id) async{
    ...
    try{
      ...
      throw ResponseModel("Error while deleting Category!. Reason: ${e.toString()}",statusCode: 500);
    }
  }
